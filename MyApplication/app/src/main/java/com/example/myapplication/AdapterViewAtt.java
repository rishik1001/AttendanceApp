...
public class AdapterViewAtt extends ArrayAdapter {
    ...
    public AdapterViewAtt(ArrayList data, Context context) {
    ...
    @Override
    public TeacherViewData getItem(int position) {
        return (TeacherViewData) dataSet.get(position);
    }
    @Override
    public View getView(int position, View convertView, @NonNull ViewGroup parent){
        AdapterViewAtt.ViewHolder viewHolder;
        final View result;
        if (convertView == null) {
            viewHolder = new AdapterViewAtt.ViewHolder();
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_att_node, parent, false);
            viewHolder.StdName = (TextView) convertView.findViewById(R.id.std_name);
            ...
            viewHolder = (AdapterViewAtt.ViewHolder) convertView.getTag();
            result=convertView;
        }
        TeacherViewData item = getItem(position);
        viewHolder.StdName.setText(item.name);
